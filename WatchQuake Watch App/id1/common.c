...
qboolean com_skipbasedir = qFalse;
...
===========
*/
int configOverride = 0;
void COM_SetConfigOverride(int i)
{
    configOverride = i;
}
...
//
    ...
    if (!configOverride && !strcmp(filename,"config.cfg"))
    {
        sprintf (netpath, "%s/%s",com_savedir, filename);
