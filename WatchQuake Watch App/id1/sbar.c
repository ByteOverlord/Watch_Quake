...
#define UIBAR_Y_OFFSET -16
#define INTERMISSION_Y_OFFSET 120
...
void Sbar_IntermissionNumber (int x, int y, int num, int digits, int color)
{
	...
	while (*ptr)
	{
		...
		Draw_TransPic (x,y + INTERMISSION_Y_OFFSET,sb_nums[color][frame]);
		x += 24;
		ptr++;
	}
}
...
void Sbar_IntermissionOverlay (void)
{
	...
	Draw_Pic (64, 24 + INTERMISSION_Y_OFFSET, pic);

	pic = Draw_CachePic ("gfx/inter.lmp");
	Draw_TransPic (0, 56 + INTERMISSION_Y_OFFSET, pic);

// time
	dig = cl.completed_time/60;
	Sbar_IntermissionNumber (160, 64, dig, 3, 0);
	num = cl.completed_time - dig*60;
	Draw_TransPic (234,64 + INTERMISSION_Y_OFFSET,sb_colon);
	Draw_TransPic (246,64 + INTERMISSION_Y_OFFSET,sb_nums[0][num/10]);
	Draw_TransPic (266,64 + INTERMISSION_Y_OFFSET,sb_nums[0][num%10]);

	Sbar_IntermissionNumber (160, 104 , cl.stats[STAT_SECRETS], 3, 0);
	Draw_TransPic (232,104 + INTERMISSION_Y_OFFSET,sb_slash);
	Sbar_IntermissionNumber (240, 104, cl.stats[STAT_TOTALSECRETS], 3, 0);

	Sbar_IntermissionNumber (160, 144 , cl.stats[STAT_MONSTERS], 3, 0);
	Draw_TransPic (232,144 + INTERMISSION_Y_OFFSET,sb_slash);
...
void Sbar_FinaleOverlay (void)
{
	...
	Draw_TransPic ( (vid.width-pic->width)/2, 16 + INTERMISSION_Y_OFFSET, pic);
}
